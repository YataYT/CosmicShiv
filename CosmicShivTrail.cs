...
namespace CalamityMod.Projectiles.Melee
{
    public class CosmicShivTrail : ModProjectile, ILocalizedModType
    {
        ...
        public readonly float maxDistanceToTarget = 540f;
        public bool initialized = false;
        public float startingVelocityY = 0f;
        public float randomAngleDelta = 0f;
        public readonly float explosionDamageMultiplier = 1.5f;
        public readonly int amountSwords = 10;
        public readonly int amountStars = Main.rand.Next(4, 6);
        public float maxSpeed = 18f;

        public static readonly List<Color> LightDustColors = new List<Color>
        {
            new Color(128, 128, 255),
            new Color(157, 128, 255),
            new Color(189, 138, 255),
            new Color(210, 156, 255),
            new Color(237, 186, 255)
        };


        public static readonly List<Color> DustColors = new List<Color>
        {
            new Color(69, 69, 222),
            new Color(99, 66, 212),
        ...
        public int fadeInDistance = 7;
        public int fadeInTime = 12;

        public override void SetStaticDefaults()
        {
            ProjectileID.Sets.TrailCacheLength[Type] = 15;      // LONG TRAIL
        ...
        public override void AI()
        {
            ...
            if (target is not null)     // TODO: Improve homing
            {
                float force = 1.6f;                

                Projectile.velocity += Projectile.SafeDirectionTo(target.Center, Vector2.UnitX) * force;
